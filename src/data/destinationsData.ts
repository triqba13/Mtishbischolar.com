...
export const DESTINATIONS: Destination[] = [
    ...
    universities: [
      {
        ...
        accreditation: "National Key & Double First Class University",
        scholarship: "Self-sponsored / CSC Scholarship",
        popularCourses: [
          { name: "B.Eng Civil Engineering", level: "Bachelor", duration: "4 Years", fee: "$2,800 / year" },
          { name: "Computer Science & Technology", level: "Bachelor", duration: "4 Years", fee: "$2,600 / year" },
  ...
  },
  {
    ...
    scholarshipMax: "International Student Loans & Scholarships",
    avgTuition: "£32,950 - £37,000 / year",
    highlights: [
      "2-Year Graduate Post-Study Work Permit (PSW)",
      "Triple-accredited global business school in London",
    ...
    universities: [
      {
        ...
        popularCourses: [
          { name: "Bachelor of Business Administration - Marketing", level: "Bachelor", duration: "48 Months", fee: "£32,950 / year" },
          { name: "Bachelor of Business Administration - Management", level: "Bachelor", duration: "48 Months", fee: "£32,950 / year" },
          { name: "Masters in Management", level: "Master", duration: "12 Months", fee: "£37,000 / year" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    universitiesCount: "Partner University",
    scholarshipMax: "Scholarships Available & Fast Acceptance",
    avgTuition: "CAD $20,300 - $22,601 / year",
    highlights: [
      "3-Year PGWP (Post Graduation Work Permit)",
      "Direct pathway to Permanent Residency (PR)",
      "Part-time work permitted during semester",
      "Fast acceptance and no visa cap",
    ],
    universities: [
      {
        name: "Algoma University",
        location: "Sault Ste. Marie, Ontario, Canada",
        accreditation: "Ontario Quality Assurance & Recognized Public University",
        scholarship: "Scholarships Available & Fast Acceptance",
        popularCourses: [
          { name: "Bachelor of Computer Science - Honours", level: "Bachelor", duration: "48 Months", fee: "CAD $22,601 / yr" },
          { name: "Bachelor of Business Administration - Honours", level: "Bachelor", duration: "48 Months", fee: "CAD $22,601 / yr" },
          { name: "Master of Science - Business Analytics", level: "Master", duration: "16 Months", fee: "CAD $20,300 / yr" },
        ],
      },
    ],
  },
