    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-3xl p-5 sm:p-7 md:p-8 text-white shadow-xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 border border-slate-700/50">
        ...
        <button
          ...
          disabled={loading}
          className="self-start sm:self-auto inline-flex items-center gap-2 px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-white/10 hover:bg-white/20 text-white font-bold text-xs border border-white/20 transition-all cursor-pointer disabled:opacity-50"
        >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
        ...
        <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/80 shadow-xs">
          <div className="flex items-center justify-between">
            <p className="text-[10px] sm:text-xs font-bold text-slate-500 uppercase tracking-wider">Total Payments</p>
            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-blue-50 flex items-center justify-center text-blue-600">
              <DollarSign className="w-4 h-4 sm:w-5 sm:h-5" />
            </div>
          </div>
          <p className="text-xl sm:text-2xl font-black text-slate-800 mt-2">{tabCounts.all}</p>
          <p className="text-[10px] sm:text-xs text-slate-400 mt-1">All payment submissions</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/80 shadow-xs">
          ...
          <p className="text-xl sm:text-2xl font-black text-amber-600 mt-2">{tabCounts.pending}</p>
          <p className="text-[10px] sm:text-xs text-slate-400 mt-1">Awaiting verification</p>
        </div>

        {/* Approved Payments */}
        <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/80 shadow-xs">
          <div className="flex items-center justify-between">
            <p className="text-[10px] sm:text-xs font-bold text-slate-500 uppercase tracking-wider">Approved</p>
            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-600">
              <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5" />
            </div>
          </div>
          <p className="text-xl sm:text-2xl font-black text-emerald-600 mt-2">{tabCounts.approved}</p>
          <p className="text-[10px] sm:text-xs text-slate-400 mt-1">Cleared transactions</p>
        </div>

        {/* Rejected Payments */}
        <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/80 shadow-xs">
          <div className="flex items-center justify-between">
            <p className="text-[10px] sm:text-xs font-bold text-slate-500 uppercase tracking-wider">Rejected</p>
            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-red-50 flex items-center justify-center text-red-600">
              <ShieldAlert className="w-4 h-4 sm:w-5 sm:h-5" />
            </div>
          </div>
          <p className="text-xl sm:text-2xl font-black text-red-600 mt-2">{tabCounts.rejected}</p>
          <p className="text-[10px] sm:text-xs text-slate-400 mt-1">Declined payments</p>
        </div>

        {/* Total Amount Received */}
        <div className="col-span-2 sm:col-span-1 bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/80 shadow-xs">
          <div className="flex items-center justify-between">
            <p className="text-[10px] sm:text-xs font-bold text-slate-500 uppercase tracking-wider">Revenue</p>
            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-purple-50 flex items-center justify-center text-purple-600 font-bold text-[10px]">
              TZS
            </div>
          </div>
          <p className="text-lg sm:text-xl font-black text-purple-700 mt-2 truncate">
            TSh {(tabCounts.approvedAmount || 0).toLocaleString()}
          </p>
          <p className="text-[10px] sm:text-xs text-slate-400 mt-1">Approved collections</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 shadow-sm overflow-hidden">
        ...
        <div className="p-4 sm:p-5 border-b border-slate-100 flex flex-col lg:flex-row lg:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <h2 className="font-extrabold text-slate-900 text-sm sm:text-base">Transactions</h2>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="relative min-w-[200px] flex-1 sm:flex-initial">
              ...
              <input
                ...
                className="w-full pl-8 pr-8 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder-slate-400 outline-none focus:border-emerald-500 transition-colors"
              />
              {searchQuery && (
                <button
                  type="button"
